...
const Offer = () => {
    ...
    return (
        <div className='offer-section w-full h-[80vh] bg-[#274C5B] '>
                ...
                <div className='h-full'>
                    <div className='flex items-center h-[20%] pt-12 '>
                        <div className='w-[90%]'>
                            ...
                            <div className='text-[32px] font-extrabold text-white'>We Offer Organic For You</div>
                        </div>
                        <div className="w-[40%]">
                            <div>
                                <button className='p-4 rounded-lg bg-[#EFD372]'>View All Product</button>
                            </div>
                        </div>
                    </div>
                    <div className="products-section w-full h-[60%] grid grid-cols-3 gap-4 pt-16 justify-items-center">                    {SlicedProducts.map((item: any) => {
                        return (
                            <div className="products-card w-[50%] h-[100%]  bg-[#F9F8F8] rounded-3xl">
